...
class Searchor {
	...
	public function trainingsearch($start = 0,$count = 15, $level, $cat, $minBid, $maxBid, $minBIN, $maxBIN) {
		$searchurl = "https://utas.fut.ea.com/ut/game/fifa13/auctionhouse?";
		//String that holds our search variables
		$searchstring = "";
		...
		//create the final search string
		$search = $searchurl . "type=training&blank=10&start=$start&num=$count" . $searchstring;
		//Set the cookie data
		$cookie_string = $this->EASW_KEY."; ".$this->EASF_SESS ."; ".$this->PHISHKEY;                                                                       
		//Setup cURL HTTP request
		$ch = curl_init($search);                                                                      
	...
	public function developmentsearch($start = 0,$count = 15, $level, $cat, $minBid, $maxBid, $minBIN, $maxBIN) {
		$searchurl = "https://utas.fut.ea.com/ut/game/fifa13/auctionhouse?";
		//String that holds our search variables
		$searchstring = "";
		...
		//create the final search string
		$search = $searchurl . "type=development&blank=10&start=$start&num=$count" . $searchstring;
		//Set the cookie data
		$cookie_string = $this->EASW_KEY."; ".$this->EASF_SESS ."; ".$this->PHISHKEY;                                                                       
		//Setup cURL HTTP request
		$ch = curl_init($search);                                                                      
